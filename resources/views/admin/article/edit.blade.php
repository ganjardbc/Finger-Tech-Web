...
<h1 class="ctn-font ctn-small ctn-font-primary-bold ctn-min-color">Edit Artikel</h1>
...
<form 
    ...
    <div class="content-create">
        <input type="hidden" id="idarticle" value="{{ $article->idarticle }}">
        ...
        <div class="cc-left">
                ...
                <div class="grid">
                    <div class="col-1 padding-bottom-10px">
                        <div
                            ...
                            style="background-image: url({{ asset('/img/article/thumbnails/'.$article->cover) }});"
                        ></div>
                    </div>
            ...
            <div class="cc-block">
                ...
                <textarea 
                    ...
                    id="content"
                    required="required"
                    class="txt txt-primary-color edit-text">{{ $article->content }}</textarea>
            </div>
        </div>
