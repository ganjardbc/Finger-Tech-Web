    ...
    { 
        ...
        if (a == true) {
			...
			.done(function(data) {
			   	if (data.status == 'success') 
                {
                    window.location = server+'/admin/service/edit/'+idowner;
                } 
                else 
                {
                    loadPopup('hide');
...
<h1 class="ctn-font ctn-small ctn-font-primary-bold ctn-min-color">Edit Konten & Layanan</h1>
                ...
                <div class="padding-top-15px">
                    <div class="col-1">
                        <div
                            ...
                            style="background-image: url({{ asset('/img/service/thumbnails/'.$sv->cover) }});"></div>
                    </div>
                    <div class="col-2">
...
<div class="content-page">
    <div class="cp-top">
        ...
        <div class="cp-right">
            <a href="{{ url('/admin/images/create/'.$idservice.'/service') }}">
