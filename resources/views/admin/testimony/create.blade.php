...
<script>
    ...
    function publish() {
        ...
        if (ctn > 0) {
            ...
            $.ajax({
                url: '{{ url("/admin/testimony/publish") }}',
				data: fd,
				processData: false,
				contentType: false,
                dataType: 'json',
...
<h1 class="ctn-font ctn-small ctn-font-primary-bold ctn-min-color">Tambah Testimony</h1>
            ...
            <div class="cc-block">
                ...
                <div class="padding-top-15px">
                    <div class="col-1">
                        <div
                            id="add-pict" 
                            class="image image-150px image-circle"></div>
                    </div>
                    <div class="col-2">
